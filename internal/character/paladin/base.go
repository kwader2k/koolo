...
const redemptionRaisersRange = core.ScreenRange + core.MeleeRange // Screen range plus a buffer in case we need to move.
const redemptionReplenishRange = 10                               // Game says 10.6 yards.
const convictionRange = 13                                        // Game says 13.3 yards.
